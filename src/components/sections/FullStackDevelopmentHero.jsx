    ...
    >
      ...
      >
          ...
          >
            ...
            {/* Main Heading */}
            <motion.h1
              className="fullstack-hero-heading"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <span style={{ display: 'block', color: '#0F172A' }}>Full Stack</span>
              <span
                style={{
                  display: 'block',
                  color: '#0F172A',
            ...
            {/* Description */}
            <motion.p
              className="fullstack-hero-description"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Build powerful, scalable web applications from frontend to backend. Our full-stack development services deliver end-to-end solutions with modern frameworks, robust APIs, and seamless database integration. Create applications that perform flawlessly across all devices and platforms.
            </motion.p>
            ...
            >
              <Link href="/contact">
                <motion.button
                  className="fullstack-hero-cta-button"
          ...
          {/* Right Image Section */}
          <motion.div
            className="fullstack-hero-image"
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
      ...
      <style jsx global>{`
        @media (max-width: 1024px) {
          ...
          .fullstack-hero-heading {
            font-size: 3rem !important;
          }
          
          .fullstack-hero-image {
        ...
        @media (max-width: 768px) {
          ...
          .fullstack-hero-overlay {
            padding: 1rem 1.5rem !important;
          }
          
          .fullstack-hero-overlay-text {
...
export default FullStackDevelopmentHero;
